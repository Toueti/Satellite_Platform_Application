...
public class ImageController {
    ...
    public ResponseEntity<GenericResponse<?>> addImage(
        ...
        @RequestPart(value = "storageType", required = false) String storageType) {
        logger.info("Received request to add image: projectId={}, imageName={}, metadata={}, file={}, storageType={}",
            projectId, imageName, metadataJson, file.getOriginalFilename(), storageType != null ? storageType : "gridfs");
        ...
        try {
            ...
            ImageDTO addedImage = imageService.addImage(dto, storageType);
