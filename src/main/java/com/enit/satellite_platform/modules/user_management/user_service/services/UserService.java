package com.enit.satellite_platform.modules.user_management.user_service.services;
...
import com.enit.satellite_platform.modules.user_management.exceptions.InvalidTokenException;
...
import com.enit.satellite_platform.modules.user_management.security.Jwt.JwtUtil;
import com.enit.satellite_platform.modules.user_management.user_service.dtos.JwtResponse;
import com.enit.satellite_platform.modules.user_management.user_service.dtos.LoginRequest;
import com.enit.satellite_platform.modules.user_management.user_service.dtos.SignUpRequest;
import com.enit.satellite_platform.modules.user_management.user_service.dtos.UserUpdateRequest;
// Removed direct import of AuthorityRepository, will use RoleService
import com.enit.satellite_platform.modules.user_management.services.RoleService; // Added import for RoleService
...
import com.enit.satellite_platform.modules.user_management.activity.service.ActivityLogService; // Added import for ActivityLogService
...
public class UserService {
    ...
    public JwtResponse accessUserAcount(LoginRequest loginRequest) {
        try {
            ...
            String userId = loggedInUser != null ? loggedInUser.getId().toString() : null;
    ...
    public JwtResponse updateUser(ObjectId userId, UserUpdateRequest updatedUser) {
        ...
        String newToken = jwtUtil.generateToken(savedUser); // Use savedUser
        return new JwtResponse(newToken, user.getId().toString());
    }
