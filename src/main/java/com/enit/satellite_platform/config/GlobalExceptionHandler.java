...
import com.enit.satellite_platform.resources_management.dto.ApiErrorResponse;
import com.enit.satellite_platform.resources_management.exception.*;
import com.enit.satellite_platform.user_management.exception.*;
import com.enit.satellite_platform.project_management.exception.*;
...
/**
 * Global exception handler for the Satellite Platform application.
...
public class GlobalExceptionHandler {
     ...
     * @return a ResponseEntity with the exception message and HTTP status UNAUTHORIZED
     */
     ...
     * @return a ResponseEntity with an ApiErrorResponse and HTTP status INTERNAL_SERVER_ERROR
     */
